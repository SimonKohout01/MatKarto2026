...
#Optimal conformal projection for Switzerland
...
u1 = 46.839906291*pi/180
v1 = 6.708828983*pi/180
u2 = 46.774154323*pi/180
v2 = 9.688180962*pi/180

#Northernmost point
u3 = 47.797987459*pi/180
v3 = 8.015538711*pi/180

#Southernmost point
u4 = 45.819533741*pi/180
v4 = 8.081613674*pi/180
...
#Exact s0 bonus 1
#We use our helper function and swiss_new.shp
s_extreme = find_extreme_s("swiss_new.shp", uk, vk)
...
print("Distortions for Switzerland:")
print(f"P1:{ny1:.6f}")
print(f"P2:{ny2:.6f}")
print(f"P3:{ny3:.6f}")
print(f"P4:{ny4:.6f}")
...
#Print results formatted to 6 decimal places
print("Distortions for Switzerland exact:")
