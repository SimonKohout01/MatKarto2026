...
Zanedbání změny elipsoidu: souřadnice, měřeny na Besselově elipsoidu, & +5b \\ \hline
Zanedbání vlivu elipsoidu: souřadnice měřeny na Gaussově kouli. & +5b \\ \hline
Transformace $(\varphi,\lambda,H)\rightarrow(Y,X,Z)$. & +10b \\ \hline
Použití dotransformace (přesnost 2cm) & +15b \\ \hline
\textbf{Max celkem:} & \textbf{60b} \\ \hline
\end{tabular}
\end{center}
